...
class DAPOConfig(TrainingArguments):
    ...
    Only the parameters pertinent to DAPO training are listed here. For a more detailed description, refer to the
    ...
    Parameters:
        ...
        temperature (`float` , defaults to 1.0):
            Temperature for sampling. The higher, the more random the generated completion will be.
        top_p (`float`, *optional*, defaults to 1.0):
            Controls the cumulative probability of tokens to consider when sampling.
        top_k (`int` or `None`, defaults to 50):
            Controls the number of highest probability tokens to consider when sampling.
        ...
        beta (`float`, *optional*, 0.0):
            Not to be used as DAPO doesn't rely upon computing KL-divergence.
        num_iterations (`int`, *optional*, defaults to `1`):
            Number of iterations per batch (denoted as μ in the algorithm).
        epsilon_low (`float`, , defaults to `0.2`):
            Epsilon value for clipping.
        epsilon_high (`float`, defaults to `0.2` if not specified):
